...
while True:
    ...
    if contours:
        ...
        if radius > 10:
            ...
            img3 = cv2.resize(img2, (100, 100), interpolation=cv2.INTER_AREA)

            # Guardar la imagen recortada en la ruta deseada
            cv2.imwrite(r'C:\Users\angel\OneDrive\Escritorio\IA\EjerciciosPy\saved_images\recorte' + str(i) + '.jpg', img3)
