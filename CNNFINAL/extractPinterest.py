#herramienta para scrapear imagenes de pinterest
...
def scrape_pinterest_images(search_query, download_folder, max_images=10):
    ...
    try:
        # Navegar a Pinterest y buscar imágenes
        ...
        print("Desplazándose para cargar imágenes...")
        for _ in range(5):  
...
if __name__ == "__main__":
    search_term = "bmw 318d touring"  
    output_folder = r"C:\Users\angel\OneDrive\Escritorio\IaA\IA\EjerciciosPy\CNNFINAL\bmwpint"
    scrape_pinterest_images(search_term, output_folder, max_images=500)
